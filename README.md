...
This project makes heavy use of relative symlinks. It also uses PHP (for nostalgia). For initial setup and updates, you must run the `dev/build.sh` script which creates symlinks to the `index.php` in every subdirectory. 
